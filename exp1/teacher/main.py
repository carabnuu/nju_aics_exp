...
from components import FullyConnectLayersrc, ReluLayersrc, CrossEntropysrc
...
class MlpMnistModel(object):
    def __init__(self, input_size, hidden1, hidden2, out_size):
        ...
        # 初始化网络中各组件
        self.fc1 = FullyConnectLayersrc(self.input_size, self.hidden1)
        self.fc2 = FullyConnectLayersrc(self.hidden1, self.hidden2)
        self.fc3 = FullyConnectLayersrc(self.hidden2, self.out_size)
        self.relu1 = ReluLayersrc()
        self.relu2 = ReluLayersrc()
