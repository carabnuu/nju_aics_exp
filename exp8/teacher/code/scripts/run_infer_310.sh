...
if [[ $# -lt 4 || $# -gt 5 ]]; then
    ...
    DATASET_NAME can choose from ['flower_photos', 'imagenet2012'].
...
if [ $2 == 'flower_photos' ] || [ $2 == 'imagenet2012' ]; then
  dataset_name=$2
else
  echo "DATASET_NAME can choose from ['flower_photos', 'imagenet2012']"
  exit 1
fi
...
function infer()
{
    ...
    if [ "$dataset_name" == "flower_photos" ]; then
