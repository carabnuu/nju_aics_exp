...
bool GenGraph(Graph& graph)
{
    ...
    auto layer2_conv1 = GenConv2dOp(ge::Shape({128,64,3, 3}),"layer2_conv1",layer1_maxpool);
    auto layer2_bn1 = GenBNOp(ge::Shape({128}),"layer2_bn1",layer2_conv1);
    auto layer2_relu1 = GenReluOp("layer2_relu1",layer2_bn1);
    auto layer2_conv2 = GenConv2dOp(ge::Shape({128,128,3,3}),"layer2_conv2",layer2_relu1);
    auto layer2_bn2 = GenBNOp(ge::Shape({128}),"layer2_bn2",layer2_conv2);
    auto layer2_relu2 = GenReluOp("layer2_relu2",layer2_bn2);
    auto layer2_maxpool = GenMaxpoolOp("layer2_maxpool",layer2_relu2);

 
    auto layer3_conv1 = GenConv2dOp(ge::Shape({256,128,3, 3}),"layer3_conv1",layer2_maxpool);
    auto layer3_bn1 = GenBNOp(ge::Shape({256}),"layer3_bn1",layer3_conv1);
    auto layer3_relu1 = GenReluOp("layer3_relu1",layer3_bn1);
    auto layer3_conv2 = GenConv2dOp(ge::Shape({256,256,3, 3}),"layer3_conv2",layer3_relu1);
    auto layer3_bn2 = GenBNOp(ge::Shape({256}),"layer3_bn2",layer3_conv2);
    auto layer3_relu2 = GenReluOp("layer3_relu2",layer3_bn2);
    auto layer3_conv3 = GenConv2dOp(ge::Shape({256,256,3, 3}),"layer3_conv3",layer3_relu2);
    auto layer3_bn3 = GenBNOp(ge::Shape({256}),"layer3_bn3",layer3_conv3);
    auto layer3_relu3 = GenReluOp("layer3_relu3",layer3_bn3);    
    auto layer3_maxpool = GenMaxpoolOp("layer3_maxpool",layer3_relu3);
 

    auto layer4_conv1 = GenConv2dOp(ge::Shape({512,256,3, 3,}),"layer4_conv1",layer3_maxpool);
    auto layer4_bn1 = GenBNOp(ge::Shape({512}),"layer4_bn1",layer4_conv1);
    auto layer4_relu1 = GenReluOp("layer4_relu1",layer4_bn1);
    auto layer4_conv2 = GenConv2dOp(ge::Shape({512, 512, 3, 3}),"layer4_conv2",layer4_relu1);
    auto layer4_bn2 = GenBNOp(ge::Shape({512}),"layer4_bn2",layer4_conv2);
    auto layer4_relu2 = GenReluOp("layer4_relu2",layer4_bn2);
    auto layer4_conv3 = GenConv2dOp(ge::Shape({512, 512, 3, 3}),"layer4_conv3",layer4_relu2);
    auto layer4_bn3 = GenBNOp(ge::Shape({512}),"layer4_bn3",layer4_conv3);
    auto layer4_relu3 = GenReluOp("layer4_relu3",layer4_bn3);
    auto layer4_maxpool = GenMaxpoolOp("layer4_maxpool",layer4_relu3);


    auto layer5_conv1 = GenConv2dOp(ge::Shape({512, 512, 3, 3}),"layer5_conv1",layer4_maxpool);
    auto layer5_bn1 = GenBNOp(ge::Shape({512}),"layer5_bn1",layer5_conv1);
    auto layer5_relu1 = GenReluOp("layer5_relu1",layer5_bn1);
    auto layer5_conv2 = GenConv2dOp(ge::Shape({512, 512, 3, 3}),"layer5_conv2",layer5_relu1);
    auto layer5_bn2 = GenBNOp(ge::Shape({512}),"layer5_bn2",layer5_conv2);
    auto layer5_relu2 = GenReluOp("layer5_relu2",layer5_bn2);
    auto layer5_conv3 = GenConv2dOp(ge::Shape({512, 512, 3, 3}),"layer5_conv3",layer5_relu2);
    auto layer5_bn3 = GenBNOp(ge::Shape({512}),"layer5_bn3",layer5_conv3);
    auto layer5_relu3 = GenReluOp("layer5_relu3",layer5_bn3);
    auto layer5_conv4 = GenConv2dOp(ge::Shape({512, 512, 3, 3}),"layer5_conv4",layer5_relu3);
    auto layer5_bn4 = GenBNOp(ge::Shape({512}),"layer5_bn4",layer5_conv4);
    auto layer5_relu4 = GenReluOp("layer5_relu4",layer5_bn4);
    auto layer5_maxpool = GenMaxpoolOp("layer5_maxpool",layer5_relu4);

    //构建flatten算子
    auto flatten = GenFlattenOp("flatten", layer5_maxpool);

    //构建dense算子
    auto fullyconnect1 = GenDenseOp(512*7*7,4096,"fullyconnect1",flatten);
    auto fullyconnect1_relu1 = GenReluOp("fullyconnect1_relu1",fullyconnect1);
    auto fullyconnect2 = GenDenseOp(4096,4096,"fullyconnect2",fullyconnect1_relu1);
    auto fullyconnect2_relu1 = GenReluOp("fullyconnect2_relu1",fullyconnect2);
    auto fullyconnect3 = GenDenseOp(4096,5,"fullyconnect3",fullyconnect2_relu1);

    auto pred = GenSoftmaxOp("softmax", fullyconnect3);
