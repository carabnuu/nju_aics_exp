...
from mindspore import load_param_into_net, load_checkpoint, export
...
def run_train():
    ...
    if config.dataset == "flower_photos":
        ...
        loss_scale_manager = amp.FixedLossScaleManager(config.loss_scale, drop_overflow_update=False)
